set :application, "inaug09"
set :repository,  "svn+ssh://babylon/mnt/data/svn/gardens/inauguration09"

set :deploy_to, "/fortiusone/live/apps/#{application}"
set :deploy_via, :copy

set :user, "root"
# set :hostname, "navigatingwashington.dynalias.com"
set :hostname, "geocommons.dynalias.com"
role :app, hostname
role :web, hostname
